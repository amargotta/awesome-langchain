...
- [@theagora/mcp](https://www.npmjs.com/package/@theagora/mcp) - MCP server for verified agent-to-agent commerce. 27 tools for browsing, purchasing, and selling AI agent services with atomic escrow, cryptographic verification, and per-function reputation.
